{
  ...
  inputs = {
    ...
    nixpkgs.url = github:nixos/nixpkgs?rev=612f97239e2cc474c13c9dafa0df378058c5ad8d;
    ...
    # Nomad, Consul, etc.
    nixpkgs-stable.url = github:nixos/nixpkgs?rev=d7f206b723e42edb09d9d753020a84b3061a79d8;
    # Flake sources.
    home-manager = {
